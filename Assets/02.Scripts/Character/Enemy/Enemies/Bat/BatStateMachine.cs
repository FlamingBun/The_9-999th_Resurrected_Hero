public class BatStateMachine:RangeEnemyStateMachine
{
    public BatStateMachine(EnemyController enemyController) : base(enemyController)
    {
        statesDict = new()
        {
            ...
            { EnemyStates.RangeAttack, new BatAttackState(enemyController, this)},
