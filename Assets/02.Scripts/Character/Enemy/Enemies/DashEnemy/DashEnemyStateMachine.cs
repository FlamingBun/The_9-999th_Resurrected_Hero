...
public class DashEnemyStateMachine:EnemyStateMachine
{
    public DashEnemyStateMachine(EnemyController enemyController) : base(enemyController)
    {
        statesDict = new()
        {
            ...
            { EnemyStates.DashAttack, new DashEnemyAttackState(enemyController, this)},
    ...
    {
        ChangeEnemyState(EnemyStates.DashAttack);
    }
}
