...
📦Assets
┣ 📂01.Scenes // 씬 파일
┣ 📂02.Scripts // 역할별 세부폴더 (예: Player, UI 등)
┣ 📂03.Prefab // 프리팹
┣ 📂04.ScriptableObject // 모든 데이터 SO로 관리
┣ 📂05.Arts
┣ 📂Model
┣ 📂Mesh
┣ 📂Textures
...
- **버전관리**: Git, iterm2, zshrc 적극 활용, 브랜치/커밋 관리 철저
- **Jira/마일스톤**: 일정, 역할, 작업량 분배/트래킹
...
> **문의/참여**
>  
> 프로젝트와 관련된 문의·참여 제안은 팀 노션이나 Jira 이슈 트래커를 이용해 주세요!
